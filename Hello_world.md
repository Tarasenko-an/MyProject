...
Все ветки объединены, конфликты разрешены!

* **git clone <URL-адрес репозитария** - клонирование внешнего репозитария на локальный диск
* **git pull** - получение изменений и слияние с локальной версией
* **git push** - отправляет локальную версию репозитария на внешний ресурс